...
const EditUserEmailTemplate = (props) => {
    ...
    useEffect(() => {
        if (props.UserEmailTemplate.getUserEmailTemplateAuth) {
            const {_id, title, type, subject, content, subjectDE, contentDE } = props.UserEmailTemplate.getUserEmailTemplate.emailTemplates
            setData({_id, title, type, subject, content, subjectDE, contentDE, _id: window.location.pathname.split('/')[3] })
            props.getEmailTypes()
            setLoader(false)
        }
                                        ...
                                        <Row>
                                            <Col md="6">
                                                <Form.Group>
                                                    ...
                                                    <Select defaultValue={data.type} onChange={setSelectedOption}
                                            ...
                                            <Col md="12" sm="12">
                                                ...
                                                <CKEditor_Editor
                                                    ...
                                                    onChange={(event, editor) => {
                                                        ...
                                                        setData({ ...data, content: contentData });
                                                    }}
                                                />
