...
module.exports = {
    ENV: {
        ...
        customerZipPath: `${process.env.REACT_APP_ASSETS_BASE_URL}lawfulinterceptionzip/`,
        lawfulIterceptionPath: `${process.env.REACT_APP_ASSETS_BASE_URL}lawfulInterception/`,
        customerOrdersPath: `${process.env.REACT_APP_ASSETS_BASE_URL}customerOrdersPDF/`,
        customerInvoicesPath: `${process.env.REACT_APP_ASSETS_BASE_URL}customerInvoicesPDF/`,
        customerCartsPath: `${process.env.REACT_APP_ASSETS_BASE_URL}customerCartsPDF/`,
        extractPath: `${process.env.REACT_APP_ASSETS_BASE_URL}customerExtract/`,
